...
const pages = ['Home','Demo', 'Features', 'Pricing', 'About', ];
...
function Navbar() {
  ...
  return (
    <AppBar position="fixed" style={{width:"100vw", color:"rgb(72,69,210)", backgroundColor:"aliceblue"}}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, gap:15, ml:20 }}>
